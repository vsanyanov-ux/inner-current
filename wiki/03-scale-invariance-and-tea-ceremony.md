...
flowchart TD
    ...
    subgraph HighVolt ["Высоковольтный контур (Империя / Стартап)"]
        ...
        Note2["Чудовищные риски страха, критики и обратного тока"]
    end
```
...
2. **Низкий риск обратного тока:**
   * Никто не ожидает, что чашка чая решит все проблемы жизни и придаст экзистенциальное величие. Она не может стать ложным генератором. Ток спокойно течёт из человека в восприятие напитка.
...
* **Искушение паразитной полярностью:** Человек начинает ждать: *«Вот когда капитализация достигнет \$100M, я наконец стану великим и спокойным»*. В этот момент полярность меняется на обратную, реактор глушится, а внутри наступает тьма и опустошение.
