...
2. **«Чувствую себя самозванцем, боюсь критики, откладываю релиз»** → Код `IMPOSTOR_VALIDATION` (Паразитный обратный ток $I < 0$).
...
flowchart TD
    ...
    D2 --> Fix2["Протокол 'Нидзиригути' (躙口): сброс эго и полярность (I > 0)"]
...
* **Протокол отладки — «Нидзиригути» (躙口, Nijiriguchi):**
  1. Активация портала **Нидзиригути**: мысленно отрезать внешний статус и меч эго у входа.
