...
flowchart TD
    ...
    D1 --> Fix1["Протокол 'Мусин': заземление в сенсорику (R -> 0)"]
    D2 --> Fix2["Протокол 'Нидзиригути': отсечение внешних опор (I > 0)"]
    D3 --> Fix3["Триада 'Дзансин + Ваби-саби + Кинцуги'"]
    D4 --> Fix4["Протокол 'Чайный светодиод': микронагрузка 10 Вт"]
    D5 --> Fix5["Регламент балансировки щита 6 ламп"]
```
...
* **Протокол отладки:**
  1. Немедленно отключить 3–4 второстепенных автомата на щите.
  2. Восстановить номинал напряжения шины, направив гарантированные 20–30 Вт в канал «Здоровье» (сон, вода, дыхание).
  3. Перевести остальные лампы в режим поочередной работы.
