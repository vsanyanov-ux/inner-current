...
| :--- | :--- | :--- | :--- | :--- |
| **I. Фасадная бутафория** | КЗ на Эго ($I_{load} = 0$, ток уходит в эго-петлю) | Высокая вычурность формы ($Z_{ext}$ завышен) | **«Потёмкинская деревня»**. Рассогласование: нет генератора под красивым фасадом. | Синдром самозванца, показуха, быстрое выгорание от необходимости удерживать образ. |
