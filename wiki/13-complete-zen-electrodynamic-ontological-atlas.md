...
### 9. Дзига (自我) / Эго $\longleftrightarrow$ Паразитный реостат $R_{ego}$ и переполюсовка цепи
* **В Дзене:** Иллюзорное представление о существовании обособленного автономного «Я». Цепляние за концепцию собственной важности, требующее постоянной подпитки и защиты.
* **В физике цепи:** Паразитный переменный резистор, врезанный прямо в линию передачи мощности. Эго поглощает ток, раскаляет кабель и провоцирует опаснейшую аварию — обратный ток ($I < 0$), требующий энергии от внешних ламп.
* **В коде:** `state.r_ego > 0` $\implies$ `DiagnosticCode.REVERSE_POLARITY`.
...
### 23. Фукиндзоку (不均斉) $\longleftrightarrow$ Динамический баланс Кирхгофа на 6 лампах жизни
...
* **В физике цепи:** Индивидуальное распределение мощности Кирхгофа по 6 главным лампам жизни (Машина, Дом, Карьера, Отношения, Здоровье, Развлечения). Система не навязывает одинаковость: у каждого человека активна своя уникальная комбинация горящих приборов.
...
| **9** | **Дзига (Эго)** | 自我 | Паразитный реостат и обратный ток | $R_{ego} \gg 0, I < 0$ |
